...
ssh "$DEPLOY_SSH_TARGET" <<EOF
    ...
    upsert_env_value CORS_ALLOWED_ORIGINS "https://mlai.au,https://www.mlai.au,https://chat.mlai.au,https://victorai.win,https://www.victorai.win"
    upsert_env_value CSRF_TRUSTED_ORIGINS "https://mlai.au,https://www.mlai.au,https://api.mlai.au,https://chat.mlai.au"

...
WORKFLOW = (
    ...
    / ".github/workflows/community-bridge-victor-ai-founder-games.yml"
).read_text()
DEPLOY_WORKFLOW = (
...
class VictorAiFounderGamesBridgeWorkflowTests(unittest.TestCase):
    def test_contract_runs_in_deployment_checks(self):
        self.assertIn("tests.test_victor_ai_founder_games_bridge_workflow", DEPLOY_WORKFLOW)

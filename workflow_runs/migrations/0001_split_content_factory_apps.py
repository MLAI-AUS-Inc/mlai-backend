            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('approval_state', models.CharField(choices=[('not_required', 'Not Required'), ('approval_required', 'Approval Required'), ('approved', 'Approved'), ('denied', 'Denied')], default='not_required', max_length=30)),
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('status', models.CharField(choices=[('pending', 'Pending'), ('running', 'Running'), ('completed', 'Completed'), ('failed', 'Failed'), ('cancelled', 'Cancelled'), ('blocked', 'Blocked'), ('skipped', 'Skipped')], db_index=True, default='pending', max_length=20)),
                        ...
                        ('run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='workflow_runs.contentfactoryrun')),
                    ],
                    options={
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('status', models.CharField(choices=[('pending', 'Pending'), ('running', 'Running'), ('completed', 'Completed'), ('failed', 'Failed'), ('cancelled', 'Cancelled'), ('blocked', 'Blocked'), ('skipped', 'Skipped')], default='pending', max_length=20)),
                        ('message', models.TextField(blank=True, default='')),
                        ('started_at', models.DateTimeField(blank=True, null=True)),
                        ('completed_at', models.DateTimeField(blank=True, null=True)),
                        ('artifacts', models.JSONField(blank=True, default=list)),
                        ...
                        ('created_at', models.DateTimeField(auto_now_add=True)),
                        ('step', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attempt_history', to='workflow_runs.contentfactoryrunstep')),
                    ],
                    options={

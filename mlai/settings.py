...
JOBS_SCHEDULER_POST_TO_SLACK = _env_is_true('JOBS_SCHEDULER_POST_TO_SLACK', False)
...
JOBS_SCRAPE_HEADLESS = _env_is_true('JOBS_SCRAPE_HEADLESS', False)
...
JOBS_TOP_PICK_LIMIT = int(os.getenv('JOBS_TOP_PICK_LIMIT', '10'))

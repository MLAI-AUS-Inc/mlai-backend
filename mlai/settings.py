...
WATT_THE_HACK_AUTO_UNLOCK = _env_is_true('WATT_THE_HACK_AUTO_UNLOCK', True)
WATT_THE_HACK_UNLOCKED_SCENARIOS = _env_list(
    'WATT_THE_HACK_UNLOCKED_SCENARIOS',
    ['t1_welcome', 't2_first_code'],
)
WATT_THE_HACK_REQUIRE_TEAM_FOR_SIM = _env_is_true('WATT_THE_HACK_REQUIRE_TEAM_FOR_SIM', False)

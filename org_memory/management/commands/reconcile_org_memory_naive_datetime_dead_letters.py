...
class Command(BaseCommand):
    help = (
        "Preview or reconcile current-target extraction dead letters caused by "
        "legacy timezone-less claim datetimes."
    )
    ...
    def handle(self, *args, **options):
        ...
        try:
            report = reconcile_naive_datetime_extraction_dead_letters(
                organization=organization,

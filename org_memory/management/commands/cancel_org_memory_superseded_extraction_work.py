...
from org_memory.extraction_health import cancel_superseded_extraction_work
from org_memory.models import OrganizationMembership


class Command(BaseCommand):
    help = (
        "Preview or cancel queued extraction work whose versioned target differs "
        "from the reviewed current target."
    )
    ...
    def handle(self, *args, **options):
        ...
        try:
            report = cancel_superseded_extraction_work(
                organization=organization,

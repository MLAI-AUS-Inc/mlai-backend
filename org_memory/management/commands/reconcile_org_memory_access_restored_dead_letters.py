...
from org_memory.runtime import reconcile_access_restored_dead_letters


class Command(BaseCommand):
    help = (
        "Preview or reconcile legacy source-access-restored work that was emitted "
        "without its source version."
    )
    ...
    def handle(self, *args, **options):
        ...
        try:
            report = reconcile_access_restored_dead_letters(
                organization=organization,

...
class Command(BaseCommand):
    help = (
        "Preview or reconcile bounded legacy extraction dead letters by scheduling "
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--superseded-schema-version", required=True)
    ...
    def handle(self, *args, **options):
        ...
        try:
            report = reconcile_legacy_extraction_dead_letters(
                ...
                superseded_schema_version=options["superseded_schema_version"],
                apply=options["apply"],

...
from jobs.services.startup_boards import collect_main_sequence_jobs, collect_startup_jobs, collect_yc_jobs
...
PHASE_1_SOURCES: tuple[SourceConfig, ...] = (
    ...
    SourceConfig("TopStartups.io", "startup_board", 0.78, True, ("AI", "machine learning", "Australia")),
    ...
    SourceConfig("Main Sequence Jobs", "vc_portfolio", 0.88, True, ("AI", "deep tech", "software")),
...
def collect_from_source(
    ...
    if source.name == "Main Sequence Jobs":
        return collect_main_sequence_jobs(limit=per_keyword_limit or 25)
